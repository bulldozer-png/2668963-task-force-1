...
<section class="modal enter-form form-modal" id="enter-form">
    <?php
        $form = ActiveForm::begin(['id' => 'login-form', 'enableAjaxValidation' => true,
                'errorCssClass' => 'field--error', 'options' => ['class' => 'log-in']]); ?>
    ...
    <?= $form->field($model, 'email', [
        ...
        ->textInput(['class' => 'enter-form-email input input-middle', 'placeholder' => 'Электронная почта']); ?>
    ...
    <?= $form->field($model, 'password', [
        ...
        ->passwordInput(['class' => 'enter-form-password input input-middle', 'placeholder' => 'Пароль']); ?>
